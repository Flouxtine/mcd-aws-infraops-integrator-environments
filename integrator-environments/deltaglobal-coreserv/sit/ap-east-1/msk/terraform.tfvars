create_msk_config = {
  "aws-sit-deltaglobalcoreserv-msk-01" : {
    kafka_version             = "3.8.x"
    broker_node_instance_type = "kafka.t3.small"
    number_of_broker_nodes    = 3
    name                      = "aws-sit-deltaglobalcoreserv-msk-01"
    ...
    broker_node_security_groups = ["sg-0580eb5a137f69854"]
    ...
    configuration_name     = "aws-sit-deltaglobalcoreserv-msk-params-01"
    ...
    kms_policy = {
    "Id": "aws-sit-deltaglobalcoreserv-msk-kms-01"
    "Statement": [
      {
        "Action": "kms:*"
        "Principal": {
