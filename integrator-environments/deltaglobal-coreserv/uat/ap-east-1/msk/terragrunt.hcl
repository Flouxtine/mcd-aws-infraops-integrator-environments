...
inputs = {
  create_msk_config = {
    "aws-uat-deltaglobalcoreserv-msk-01" : {
      kafka_version             = "3.8.x"
      broker_node_instance_type = "kafka.t3.small"
      number_of_broker_nodes    = 3
      name                      = "aws-uat-deltaglobalcoreserv-msk-01"
      ...
      broker_node_security_groups = [dependency.sg.outputs.aws_security_group_output["aws-uat-deltaglobalcoreserv-sg-msk-01"].aws_security_group_id]
      ...
      configuration_name     = "aws-uat-deltaglobalcoreserv-msk-params-01"
      ...
      kms_alias_name = "aws-uat-deltaglobalcoreserv-msk-kms-01"
      kms_multi_region = true
      kms_policy = {
        "Id": "aws-uat-deltaglobalcoreserv-msk-kms-01"
        "Statement": [
          {
            "Action": "kms:*"
            "Principal": {
