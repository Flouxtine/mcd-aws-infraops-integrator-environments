create_eks_config = {
  aws-foundation-infra-eks-01 = {
    cluster_name                  = "aws-foundation-infra-eks-01"
    ...
    cluster_security_group_ids                  = ["sg-06124f76f7e160bf7"]
    ...
    tags = {
      "Mcd-Project"                                 = "Foundation"
      "Name"                                        = "eksctl-aws-foundation-infra-eks-01-cluster/ControlPlane"
      "alpha.eksctl.io/cluster-name"                = "aws-foundation-infra-eks-01"
      "alpha.eksctl.io/cluster-oidc-enabled"        = "false"
      "alpha.eksctl.io/eksctl-version"              = "0.206.0"
      "eksctl.cluster.k8s.io/v1alpha1/cluster-name" = "aws-foundation-infra-eks-01"
      "env"                                         = "infra"
    }
    ...
    addons = {
      ...
      "aws-efs-csi-driver" = {
        ...
        pod_identity_association = {
          role_arn        = "arn:aws:iam::863518445962:role/AmazonEKSPodIdentityAmazonEFSCSIDriverRole"
    ...
    node_groups = {
      "nodegroup01" = {
        ...
        launch_template = {
          nodegroup01 = {
            id      = "lt-0e9c8afac77ecd71e"
            name    = "eksctl-aws-foundation-infra-eks-01-nodegroup-nodegroup01"
            version = 1
          }
        }
      }
