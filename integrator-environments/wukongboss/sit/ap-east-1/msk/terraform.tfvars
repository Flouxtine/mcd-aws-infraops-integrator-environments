create_msk_config = {
  "aws-wukongboss-sit-msk-01" : {
    kafka_version             = "3.6.0"
    broker_node_instance_type = "kafka.t3.small"
    number_of_broker_nodes    = 2
    name                      = "aws-wukongboss-sit-msk-01"
    broker_node_client_subnets = [
      "subnet-0a2d47f6b737591f1",
      "subnet-0e6ad4b4485340ab4",

    ]
    broker_node_security_groups = ["sg-097376a27551b5746"]
    ...
    configuration_name     = "aws-wukongboss-sit-msk-params-01"
