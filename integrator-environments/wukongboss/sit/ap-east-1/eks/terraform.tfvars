create_eks_config = {
  aws-wukongboss-sit-eks-01 = {
    cluster_name                  = "aws-wukongboss-sit-eks-01"
    ...
    cluster_security_group_ids                  = ["sg-0ac7be678a7905afb"]
    ...
    tags = {
      "Mcd-Project"                                 = "wukongboss"
      "Name"                                        = "eksctl-aws-wukongboss-sit-eks-01-cluster/ControlPlane"
      "alpha.eksctl.io/cluster-name"                = "aws-wukongboss-sit-eks-01"
      "alpha.eksctl.io/cluster-oidc-enabled"        = "false"
      "alpha.eksctl.io/eksctl-version"              = "0.206.0"
      "eksctl.cluster.k8s.io/v1alpha1/cluster-name" = "aws-wukongboss-sit-eks-01"
      "env"                                         = "sit"
    }
    ...
    node_groups = {
      "nodegroup01" = {
        ...
        launch_template = {
          nodegroup01 = {
            id      = "lt-03336b7f9d00a259f"
            name    = "eksctl-aws-wukongboss-sit-eks-01-nodegroup-nodegroup01"
            version = 1
          }
        }
      }
      "nodegroup02" = {
        node_group_name = "bossfoundation-sit-nodegroup02"
        node_role_arn   = "arn:aws:iam::863518445962:role/EKSNodeGroupRole"
        ...
        labels = {
          "alpha.eksctl.io/cluster-name"   = "aws-wukongboss-sit-eks-01"
          "alpha.eksctl.io/nodegroup-name" = "bossfoundation-sit-nodegroup02"
          "role"                           = "workers"
        }
        tags = {
          "Mcd-Project"                                 = "wukongboss"
        ...
        launch_template = {
          nodegroup01 = {
            id      = "lt-04b301fc790f7e4c3"
            name    = "eksctl-aws-bossfoundation-sit-eks-01-nodegroup-nodegroup01"
            version = 1
          }
        }
      }
