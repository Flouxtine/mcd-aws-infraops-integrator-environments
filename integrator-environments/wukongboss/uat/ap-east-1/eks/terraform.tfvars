create_eks_config = {
  aws-wukongboss-uat-eks-01 = {
    cluster_name                  = "aws-wukongboss-uat-eks-01"
    ...
    cluster_security_group_ids                  = ["sg-0111e7a54da9bbc19"]
    ...
    tags = {
      "Mcd-Project"                                 = "wukong"
      "Name"                                        = "eksctl-aws-wukongboss-uat-eks-01-cluster/ControlPlane"
      "alpha.eksctl.io/cluster-name"                = "aws-wukongboss-uat-eks-01"
      "alpha.eksctl.io/cluster-oidc-enabled"        = "false"
      "alpha.eksctl.io/eksctl-version"              = "0.206.0"
      "eksctl.cluster.k8s.io/v1alpha1/cluster-name" = "aws-wukongboss-uat-eks-01"
      "env"                                         = "sit"
    }
    ...
    node_groups = {
      "nodegroup01" = {
        ...
        launch_template = {
          nodegroup01 = {
            id      = "lt-0f096d2555ab0a99e"
            name    = "eksctl-aws-wukongboss-uat-eks-01-nodegroup-nodegroup01"
            version = 1
          }
        }
      }
      "nodegroup02" = {
        node_group_name = "bossfoundation-uat-nodegroup02"
        node_role_arn   = "arn:aws:iam::863518445962:role/EKSNodeGroupRole"
        ...
        labels = {
          "alpha.eksctl.io/cluster-name"   = "aws-wukongboss-uat-eks-01"
          "alpha.eksctl.io/nodegroup-name" = "bossfoundation-uat-nodegroup02"
          "role"                           = "workers"
        }
        tags = {
