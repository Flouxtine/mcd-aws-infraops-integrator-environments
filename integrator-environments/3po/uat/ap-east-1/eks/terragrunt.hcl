...
inputs = {
  create_eks_config = {
    aws-uat-3poeks-02 = {
      cluster_name                  = "aws-uat-3poeks-02"
      ...
      node_groups = {
        "nodegroup01" = {
          node_group_name = "aws-uat-3poeks-nodegroup-01"
          ...
          launch_template = {
            nodegroup01 = {
              id      = dependency.launch_template.outputs.aws_launch_template_output["eksctl-aws-uat-3poeks-01-nodegroup-nodegroup01"].aws_launch_template_id
