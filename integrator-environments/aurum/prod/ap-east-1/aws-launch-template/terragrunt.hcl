...
inputs = {
  create_aws_launch_template_config = {
    eksctl-aws-aurum-prod-eks-01-nodegroup-nodegroup01 = {
      create_aws_launch_template = true
      name                       = "eksctl-aws-aurum-prod-eks-01-nodegroup-nodegroup01"
      region                     = "ap-east-1"
      key_name                   = dependency.key_pair.outputs.aws_key_pair_output["aws-aurum-prod-key-eks-01"].aws_key_pair_key_name
      ...
      tags = {
        Name = "aws-aurum-prod-eks-01-nodegroup01-Node"
      }
    }
  }
}
