...
inputs = {
  create_eks_config = {
    aws-bossfoundation-dev-eks-01 = {
      cluster_name                  = "aws-bossfoundation-dev-eks-01"
      ...
      tags = {
        ...
        "Name"                                        = "eksctl-aws-bossfoundation-dev-eks-01-cluster/ControlPlane"
        "alpha.eksctl.io/cluster-name"                = "aws-bossfoundation-dev-eks-01"
        "alpha.eksctl.io/cluster-oidc-enabled"        = "false"
        "alpha.eksctl.io/eksctl-version"              = "0.206.0"
        "eksctl.cluster.k8s.io/v1alpha1/cluster-name" = "aws-bossfoundation-dev-eks-01"
        "env"                                         = "dev"
      }
      ...
      node_groups = {
        "nodegroup01" = {
          ...
          launch_template = {
            nodegroup01 = {
              id      = dependency.launch_template.outputs.aws_launch_template_output["eksctl-aws-bossfoundation-dev-eks-01-nodegroup-nodegroup01"].aws_launch_template_id
