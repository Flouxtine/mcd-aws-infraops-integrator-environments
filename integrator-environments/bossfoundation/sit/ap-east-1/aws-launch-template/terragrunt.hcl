...
inputs = {
  create_aws_launch_template_config = {
    eksctl-aws-bossfoundation-sit-eks-01-nodegroup-nodegroup01 = {
      create_aws_launch_template = true
      name                       = "eksctl-aws-bossfoundation-sit-eks-01-nodegroup-nodegroup01"
      region                     = "ap-east-1"
      key_name                   = dependency.key_pair.outputs.aws_key_pair_output["aws-bossfoundation-sit-key-eks-01"].aws_key_pair_key_name
      ...
      tag_specifications = [{
        ...
        tags = {
          Name          = "aws-bossfoundation-sit-eks-01-nodegroup01-Node"
          project       = "bossfoundation"
          env           = "sit"
          Mcd-Project   = "bossfoundation"
          project_owner = ""
